...
interface HomePageViewProps {
  /** Hand-picked case studies surfaced on the homepage. Resolved by slug
   *  on the server so the order is independent of MDX file order. */
  featured: CaseStudy[];
  posts: BlogPost[];
}

export function HomePageView({ featured: FEATURED, posts: BLOG_POSTS }: HomePageViewProps) {
